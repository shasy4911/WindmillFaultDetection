...
from file_utilities.utils import encodeImageIntoBase64
...
class MultiClassObj:
    def __init__(self, imagePath, modelPath):
        ...
        self.class_names_mapping = {1: "faulty", 2: "working"}
    ...
    def getPrediction(self):
        ...
        top_scores = [e for l2 in scores for e in l2 if e > 0.70]
        ...
        print("class_final_names:",class_final_names)
        ...
        print("Output List: ", listOfOutput)
        return listOfOutput
